    ...
    return (
        <>
            <main className="w-full h-screen flex flex-col items-center justify-center sm:px-4">
                <div className="w-full space-y-6 text-zinc-400 sm:max-w-md">
                    <div className="text-center">

                        <div className="mt-5 space-y-2">
                            <h3 className="text-white text-2xl font-bold sm:text-3xl">{t("One")}</h3>
                            <p className="">{t("Two")} <a href={`/${lang}/register`} className="font-medium text-primary hover:text-primary/80">{t("Three")}</a></p>
                        </div>
                    </div>
                    <div className=" shadow p-4 py-6  sm:p-6 sm:rounded-lg">
                        <div className="w-full flex flex-row gap-4">
                            <button onClick={() => signIn('google')} className="flex items-center bg-zinc-900 justify-center py-2.5 border border-zinc-600 rounded-lg hover:bg-zinc-700 duration-150 active:bg-zinc-500 w-1/2">
                        ...
                        <div className="relative mt-10">
                            <span className="block w-full h-px bg-zinc-600"></span>
                            <p className="inline-block w-fit text-sm bg-black px-2 absolute -top-2 inset-x-0 mx-auto">{t("Four")}</p>
                        </div>
                        <form
                            onSubmit={loginUser}
                            className="space-y-5"
                        >
                            <div className='mt-8 relative'>
                                ...
                                <div className=' relative'>
                                    <input
                                        ...
                                        required
                                        className="w-full py-3 border bg-zinc-900 focus:bg-black border-zinc-700 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow"
                                        placeholder={t("Seven")}
                                    >
                                    </input>
                                </div>
                            ...
                            <div className='mt-4'>
                                ...
                                <input
                                    ...
                                    className="w-full py-3 border bg-zinc-900 focus:bg-black border-zinc-700 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder={t("Eight")}
                                />
                            </div>
                            <button
                                type="submit"
                                className=" mt-6 w-full rounded-full py-3 border text-primary font-medium bg-primary hover:text-black hover:bg-primary/80  border-primary hover:shadow inline-flex space-x-2 items-center justify-center"
                            >
                                {t("Nine")}
                            </button>
                        </form>
                    ...
                    <div className="text-center">
                        <a href={`/${lang}/change`} className="hover:text-primary">{t("Ten")}?</a>
                    </div>
                </div>
            </main>
